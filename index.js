...
const username = '@DannerMan4'
const password = 'Hopika2021' 
...
(async () => {
    ...
    await page.waitFor('input[data-testid="SearchBox_Search_Input"]');
        await page.type('input[data-testid="SearchBox_Search_Input"]', '#tesla' , {delay:25});
         ...
         //  await page.click('a[class="css-4rbku5 css-18t94o4 css-1dbjc4n r-sdzlij r-1loqt21 r-1adg3ll r-ahm1il r-1ny4l3l r-1udh08x r-o7ynqc r-6416eg r-13qz1uu"]') 
         //  await page.waitFor(2000)
  ...
  //   console.log(authorsSet);
   ...
   for (let i = 0; i < urls.length; i++) {
     try {
       ...
       await page.waitFor(2000)
       await page.click('div[class="css-18t94o4 css-1dbjc4n r-1niwhzg r-p1n3y5 r-sdzlij r-1phboty r-rs99b7 r-1w2pmg r-1vuscfd r-1dhvaqw r-1ny4l3l r-1fneopy r-o7ynqc r-6416eg r-lrvibr"]')
       await page.waitFor(2000)
       await page.goBack();
     }
     catch(error) {
